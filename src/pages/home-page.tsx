...
export function HomePage() {
  ...
  const copy = locale === "ko" ? {
    skip: "본문으로 건너뛰기", profile: "프로필 자세히 보기", focusLabel: "서로 다른 작업을 잇는 세 개의 축", focusTitle: "경계를 넘나들며, 문제를 끝까지 파고듭니다.",
    focusCta: "전체 작업에서 연구축 따라가기", workLabel: "대표 기록", workTitle: "기록으로 남긴 연구와 경험", workBody: "메인에는 대표 작업만 남겼습니다. 전체 연구·프로젝트·교육·활동은 아카이브에서 검색하거나 태그로 모아볼 수 있습니다.", workCta: "전체 아카이브 검색하기",
    journeyLabel: "배움에서 운영까지", journeyTitle: "학습을 조직하고 경험으로 남긴 시간", journeyBody: "학위, 연구, 교육과 학생자치 경험은 서로 떨어진 목록이 아니라 문제를 보는 관점을 넓혀 온 흐름입니다.", journeyCta: "학위·경력 타임라인 보기",
    ...
    skip: "Skip to content", profile: "View full profile", focusLabel: "Three axes connecting different kinds of work", focusTitle: "Crossing boundaries, staying with the question.",
    focusCta: "Follow these axes through the archive", workLabel: "Representative records", workTitle: "Research and experiences, made tangible", workBody: "Only selected work appears here. Search the archive or combine tags to explore every research, project, teaching, and activity record.", workCta: "Search the full archive",
    journeyLabel: "From learning to operating", journeyTitle: "Organizing learning and turning it into experience", journeyBody: "Degrees, research, teaching, and student governance form one path that has expanded how I frame and solve problems.", journeyCta: "View the education and career timeline",
